...
<div class="breadcrumb">
    <div class="container">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <div class="d-flex justify-content-start align-items-center"><a href="<?php echo e(route('shop'), false); ?>" class="text-black text-decoration-none">Cửa hàng</a></div>
            <div class="d-flex justify-content-start align-items-center"><span style="font-size:14px;"><i class="bi bi-chevron-right"></i></span></div>
            <div class="d-flex justify-content-start align-items-center"><a href="<?php echo e(route('sanPhamBanChay'), false); ?>" class="text-black text-decoration-none">Sảm phẩm bán chạy</a></div>
        </div>
    </div>
</div>

<div class="container  mb-5">
    <?php if(getSlide('shop-bestseller')): ?>
    <div class="text-center p-0">
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="false">
            <div class="carousel-indicators ">
                <div class="">
                    <?php if(getSlide('shop-bestseller') != null): ?>
                    <?php $__currentLoopData = getSlide('shop-bestseller'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-12 col-sm-9">
            <div class="shop-product">
                <div class="categories-top-header d-flex justify-content-between ">
                    <h1 class="text-title-heading">Sản phẩm bán chạy</h1>
                    <div class="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\smartaudio\resources\views/products/san-pham-ban-chay.blade.php ENDPATH**/ ?>