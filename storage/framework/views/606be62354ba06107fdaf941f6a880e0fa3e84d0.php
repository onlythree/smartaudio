...
<div class="breadcrumb">
    <div class="container">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <div class="d-flex justify-content-start align-items-center"><a href="<?php echo e(route('detail-lv3',['slug'=>$pcate->slug,'sluglv2'=>$categories->slug,'sluglv3'=>$cate3->slug]), false); ?>" class="text-black text-decoration-none"><?php echo e($cate3->title, false); ?></a></div>
        </div>
    </div>
</div>
<div class="container">
    <div class="categories-description">
        <?php echo $cate3->content; ?>
    ...
    <div class="row">
        <div class="col-12 col-sm-3 order-2 order-sm-1">
            <div class="widget categories">
                ...
                <ul class="list-style-none p-0 mb-0">
                    ...
                    <li>
                        <?php if(count($childCate3)> 0): ?>
                        <ul class="list-style-none ps-0">
                            <?php $__currentLoopData = $childCate3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ccate3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="<?php if($ccate3->slug == $cate3->slug): ?> active <?php endif; ?>">
                                <a href="<?php echo e(route('detail-lv3',['slug'=>$pcate->slug,'sluglv2'=>$categories->slug,'sluglv3'=>$ccate3->slug]), false); ?>" class="text-decoration-none"><i class="bi bi-caret-right-fill"></i> <?php echo e($ccate3->title, false); ?></a>
                            </li>
                ...
                <ul class="list-style-none p-0 mb-0">
                    <li class="px-3 py-1 d-flex">
                        ...
                        <label for="reviews-5" class="d-flex mx-2">
                            <a href="<?php echo e($fullUrl, false); ?>&product_count=<?php echo e(request()->product_count, false); ?>&filter_price=<?php echo e(request()->filter_price, false); ?>&brand=<?php echo e(request()->brand, false); ?>&rate=5&sort=<?php echo e(request()->sort, false); ?>&view=<?php echo e(request()->view, false); ?>" class="text-decoration-none text-gray">
                                <div class="d-flex">
                    ...
                    <li class="px-3 py-1 d-flex">
                        ...
                        <label for="reviews-4" class="d-flex mx-2">
                            <a href="<?php echo e($fullUrl, false); ?>&product_count=<?php echo e(request()->product_count, false); ?>&filter_price=<?php echo e(request()->filter_price, false); ?>&brand=<?php echo e(request()->brand, false); ?>&rate=4&sort=<?php echo e(request()->sort, false); ?>&view=<?php echo e(request()->view, false); ?>" class="text-decoration-none text-gray">
                                <div class="d-flex">
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                    ...
                    <li class="px-3 py-1 d-flex">
                        ...
                        <label for="reviews-3" class="d-flex mx-2">
                            <a href="<?php echo e($fullUrl, false); ?>&product_count=<?php echo e(request()->product_count, false); ?>&filter_price=<?php echo e(request()->filter_price, false); ?>&brand=<?php echo e(request()->brand, false); ?>&rate=3&sort=<?php echo e(request()->sort, false); ?>&view=<?php echo e(request()->view, false); ?>" class="text-decoration-none text-gray">
                                <div class="d-flex">
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                    ...
                    <li class="px-3 py-1 d-flex">
                        ...
                        <label for="reviews-2" class="d-flex mx-2">
                            <a href="<?php echo e($fullUrl, false); ?>&product_count=<?php echo e(request()->product_count, false); ?>&filter_price=<?php echo e(request()->filter_price, false); ?>&brand=<?php echo e(request()->brand, false); ?>&rate=2&sort=<?php echo e(request()->sort, false); ?>&view=<?php echo e(request()->view, false); ?>" class="text-decoration-none text-gray">
                                <div class="d-flex">
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star color-yellow mx-1"></i>
                    ...
                    <li class="px-3 py-1 d-flex">
                        ...
                        <label for="reviews-1" class="d-flex mx-2">
                            <a href="<?php echo e($fullUrl, false); ?>&product_count=<?php echo e(request()->product_count, false); ?>&filter_price=<?php echo e(request()->filter_price, false); ?>&brand=<?php echo e(request()->brand, false); ?>&rate=1&sort=<?php echo e(request()->sort, false); ?>&view=<?php echo e(request()->view, false); ?>" class="text-decoration-none text-gray">
                                <div class="d-flex">
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star color-yellow mx-1"></i>
                                    <i class="bi bi-star color-yellow mx-1"></i>
        ...
        <div class="col-12 col-sm-9 order-1 order-sm-2">
            <div class="categories-top-header d-flex justify-content-between mx-1">
                <h1 class="text-title-heading"><?php echo e($cate3->title, false); ?></h1>
                <div class="">
                    Hiện thị toàn bộ <?php echo e(countProductIncate($cate3->id), false); ?> sản phẩm
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\smartaudio\resources\views/categories/category_show_lv3.blade.php ENDPATH**/ ?>