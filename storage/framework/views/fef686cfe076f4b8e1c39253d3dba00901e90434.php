...
<div class="breadcrumb">
    <div class="container">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <div class="d-flex justify-content-start align-items-center"><a href="<?php echo e(route('detail-lv2',['slug'=>$pcate->slug,'sluglv2'=>$categories->slug]), false); ?>" class="text-black text-decoration-none"><?php echo e($categories->title, false); ?></a></div>
        </div>
    </div>
</div>
<div class="container">
                ...
                <ul class="list-style-none p-0 mb-0">
                    ...
                    <li>
                        ...
                        <ul class="list-style-none ps-0">
                            <?php $__currentLoopData = $childCate3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="<?php echo e(route('detail-lv3',['slug'=>$pcate->slug,'sluglv2'=>$categories->slug,'sluglv3'=>$cate3->slug]), false); ?>" class="text-decoration-none"><i class="bi bi-caret-right-fill"></i> <?php echo e($cate3->title, false); ?></a>
                            </li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\smartaudio\resources\views/categories/category_show_lv2.blade.php ENDPATH**/ ?>