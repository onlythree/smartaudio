...
<div class="products-items">
    <div class="product-box-border bg-white col-12">
            ...
            <div class="position-relative product_images">
                ...
                <div class="second-image position-absolute top-0" style="width: 100%;height: 100%;">
                    ...
                    <div class="product-button">
                        <div class="d-flex">
                        <div class="product-button-icon addtocart__button cursor-pointer" data-product-id="<?php echo e($prod['id'], false); ?>">
                            ...
                            <div class="product-button-icon addtolove__button cursor-pointer"  data-product-id="<?php echo e($prod['id'], false); ?>">
                            ...
                            <div class="product-button-icon addtocompare__button cursor-pointer"  data-product-id="<?php echo e($prod['id'], false); ?>">
                            ...
                            data-product-rate="<?php echo e($productRate, false); ?>" 
                            data-product-category="<?php echo e($cate['title'], false); ?>">
...
</div><?php /**PATH /home/smartaudio/domains/smartaudio.vn/public_html/resources/views/homepage/product-items.blade.php ENDPATH**/ ?>