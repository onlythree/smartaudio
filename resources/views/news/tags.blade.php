...
<section id="wrapper">
    <div class="breadcrumb">
        <div class="container">
            ...
            <div class="breadcrum">
                <a href="{{ url('/') }}" class="text-decoration-none"><b>Home</b></a> /
                <a href="#">{{ $tags->title }}</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 col-sm-8">
            ...
            <div class="rounded bg-white p-2 mb-3">
                <div class="row">
                    @foreach ($news as $ne)
                    <div class="news-items col-6 col-sm-4">
                        <a href="{{ route('detail',$ne->slug) }}" class="text-decoration-none">
                            <img src="{{ Storage::url($ne->images) }}" alt="{{ $ne->title }}" class="w-100" style="max-height:160px;">
