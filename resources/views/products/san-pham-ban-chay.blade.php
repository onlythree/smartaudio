...
<div class="breadcrumb">
    <div class="container">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <div class="d-flex justify-content-start align-items-center"><span style="font-size:14px;"><i class="bi bi-chevron-right"></i></span></div>
            <div class="d-flex justify-content-start align-items-center"><a href="{{ route('sanPhamBanChay') }}" class="text-black text-decoration-none">Sảm phẩm bán chạy</a></div>
        </div>
    </div>
</div>

<div class="container  mb-5">
    @if(getSlide('shop-bestseller'))
    <div class="text-center p-0">
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="false">
            <div class="carousel-indicators ">
                <div class="">
                    @if (getSlide('shop-bestseller') != null)
                    @foreach (getSlide('shop-bestseller') as $slide)
