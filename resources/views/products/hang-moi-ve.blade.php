...
<div class="breadcrumb">
    <div class="container">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <div class="d-flex justify-content-start align-items-center"><span style="font-size:14px;"><i class="bi bi-chevron-right"></i></span></div>
            <div class="d-flex justify-content-start align-items-center"><a href="{{ route('hangMoiVe') }}" class="text-black text-decoration-none">Sản phẩm mới</a></div>
        </div>
    </div>
</div>

<div class="container  mb-5">
    @if(getSlide('shop-new'))
    <div class="text-center p-0">
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="false">
            <div class="carousel-indicators ">
                <div class="">
                    @if (getSlide('shop-new') != null)
                    @foreach (getSlide('shop-new') as $slide)
        ...
        <div class="col-12 col-sm-9">
            <div class="shop-product">
                <div class="categories-top-header d-flex justify-content-between ">
                    <h1 class="text-title-heading">Sản phẩm mới</h1>
                    <div class="">
