    ...
    <div class="position-relative product_images">
        ...
        <div class="second-image position-absolute top-0">
            ...
            <div class="product-button">
                <div class="d-flex">
                <div class="product-button-icon addtocart__button cursor-pointer" data-product-id="{{ $prod['product_id'] }}">
                    ...
                    <div class="product-button-icon addtolove__button cursor-pointer"  data-product-id="{{ $prod['product_id'] }}">
                    ...
                    <div class="product-button-icon addtocompare__button cursor-pointer"  data-product-id="{{ $prod['product_id'] }}">
                    ...
                    data-product-other-image='<div id="quickview-img" class="carousel slide">
                                            ...
                                            data-product-rate="{{ $productRate }}" data-product-category="{{ $cate['title'] }}">
...
<div class="product-infor mt-3">
    ...
    @endif
    <h3 class="product-title"><a href="{{ route('detail',$prod['slug']) }}" class="text-decoration-none fw-bold">{{$prod['title']}}</a></h3>
