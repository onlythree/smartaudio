...
<div class="breadcrumb">
    <div class="container">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <div class="d-flex justify-content-start align-items-center"><a href="{{  route('detail-lv3',['slug'=>$pcate->slug,'sluglv2'=>$categories->slug,'sluglv3'=>$cate3->slug]) }}" class="text-black text-decoration-none">{{ $cate3->title }}</a></div>
        </div>
    </div>
</div>
<div class="container">
    ...
    <div class="row">
        <div class="col-12 col-sm-3 order-2 order-sm-1">
            <div class="widget categories">
                ...
                <ul class="list-style-none p-0 mb-0">
                    ...
                    <li>
                        @if(count($childCate3)> 0)
                        <ul class="list-style-none ps-0">
                            @foreach($childCate3 as $ccate3)
                            <li class="@if($ccate3->slug == $cate3->slug) active @endif">
                                <a href="{{ route('detail-lv3',['slug'=>$pcate->slug,'sluglv2'=>$categories->slug,'sluglv3'=>$ccate3->slug])}}" class="text-decoration-none"><i class="bi bi-caret-right-fill"></i> {{ $ccate3->title }}</a>
                            </li>
                            @endforeach
                        </ul>
                        @endif
                ...
                <ul class="list-style-none p-0 mb-0">
                    <li class="px-3 py-1 d-flex">
                        ...
                        <label for="reviews-5" class="d-flex mx-2">
                            <a href="{{ $fullUrl }}&product_count={{ request()->product_count }}&filter_price={{ request()->filter_price }}&brand={{ request()->brand }}&rate=5&sort={{ request()->sort }}&view={{ request()->view }}" class="text-decoration-none text-gray">
                                <div class="d-flex">
                    ...
                    <li class="px-3 py-1 d-flex">
                        ...
                        <label for="reviews-4" class="d-flex mx-2">
                            <a href="{{ $fullUrl }}&product_count={{ request()->product_count }}&filter_price={{ request()->filter_price }}&brand={{ request()->brand }}&rate=4&sort={{ request()->sort }}&view={{ request()->view }}" class="text-decoration-none text-gray">
                                <div class="d-flex">
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                    ...
                    <li class="px-3 py-1 d-flex">
                        ...
                        <label for="reviews-3" class="d-flex mx-2">
                            <a href="{{ $fullUrl }}&product_count={{ request()->product_count }}&filter_price={{ request()->filter_price }}&brand={{ request()->brand }}&rate=3&sort={{ request()->sort }}&view={{ request()->view }}" class="text-decoration-none text-gray">
                                <div class="d-flex">
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                    ...
                    <li class="px-3 py-1 d-flex">
                        ...
                        <label for="reviews-2" class="d-flex mx-2">
                            <a href="{{ $fullUrl }}&product_count={{ request()->product_count }}&filter_price={{ request()->filter_price }}&brand={{ request()->brand }}&rate=2&sort={{ request()->sort }}&view={{ request()->view }}" class="text-decoration-none text-gray">
                                <div class="d-flex">
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star color-yellow mx-1"></i>
                    ...
                    <li class="px-3 py-1 d-flex">
                        ...
                        <label for="reviews-1" class="d-flex mx-2">
                            <a href="{{ $fullUrl }}&product_count={{ request()->product_count }}&filter_price={{ request()->filter_price }}&brand={{ request()->brand }}&rate=1&sort={{ request()->sort }}&view={{ request()->view }}" class="text-decoration-none text-gray">
                                <div class="d-flex">
                                    <i class="bi bi-star-fill color-yellow mx-1"></i>
                                    <i class="bi bi-star color-yellow mx-1"></i>
                                    <i class="bi bi-star color-yellow mx-1"></i>
        ...
        <div class="col-12 col-sm-9 order-1 order-sm-2">
            <div class="categories-top-header d-flex justify-content-between mx-1">
                <h1 class="text-title-heading">{{ $cate3->title }}</h1>
                <div class="">
                    Hiện thị toàn bộ {{countProductIncate($cate3->id)}} sản phẩm
                </div>
            </div>
