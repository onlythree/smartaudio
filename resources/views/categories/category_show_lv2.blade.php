...
<div class="breadcrumb">
    <div class="container">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <div class="d-flex justify-content-start align-items-center"><a href="{{ route('detail-lv2',['slug'=>$pcate->slug,'sluglv2'=>$categories->slug]) }}" class="text-black text-decoration-none">{{ $categories->title }}</a></div>
        </div>
    </div>
</div>
<div class="container">
                ...
                <ul class="list-style-none p-0 mb-0">
                    ...
                    <li>
                        ...
                        <ul class="list-style-none ps-0">
                            @foreach($childCate3 as $cate3)
                            <li>
                                <a href="{{ route('detail-lv3',['slug'=>$pcate->slug,'sluglv2'=>$categories->slug,'sluglv3'=>$cate3->slug])}}" class="text-decoration-none"><i class="bi bi-caret-right-fill"></i> {{ $cate3->title }}</a>
                            </li>
                            @endforeach
                        </ul>
                        @endif
