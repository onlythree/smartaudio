...
<footer>
    <div class="container-fluid px-0" style="padding-top: 60px;">
        <div class="before_footer">
            <div class="container d-flex justify-content-between @if($agent->isMobile()) flex-column @endif">
    ...
    <div class="end pb-2">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-6">
                    <div class="float-end">
                        <img src="{{ asset('asset/image/payment-logo.webp') }}" alt="payment access" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-sm-6">
                        <a href="{{ route('shoppingCartOrder') }}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-sm-6">
                        <a href="{{ route('compare-list-page') }}">
                    ...
                    <?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-8">
                                <ul class="user-menu">
                                    <li class="d-flex"><i class="bi bi-caret-right-fill"></i><a class="text-decoration-none text-black" href="{{ route('profile') }}">Trang cá nhân</a></li>
                                    <li class="d-flex"><i class="bi bi-caret-right-fill"></i><a class="text-decoration-none text-black" href="{{ route('getOrder') }}">Đơn hàng đã mua</a></li>
                                    <li class="d-flex"><i class="bi bi-caret-right-fill"></i><a class="text-decoration-none text-black" href="{{ route('change-password') }}">Đổi mật khẩu</a></li>
                                    <li class="d-flex"><i class="bi bi-caret-right-fill"></i><a class="text-decoration-none text-black" href="{{ route('logout') }}">Đăng xuất</a></li>
                                </ul>
                            </div>
                        </div>
                    <?php
